...
I \srcref{ex02/makefile_output.txt} ses en del af outputtet fra \texttt{makefilen} ---
her ses det at operationen var vellykket.

\dsdsrc{ex02/makefile_output.txt}{Udsnit af output fra \texttt{makefile}-operationen, kørt via \texttt{cygwin64}}{tpb}
